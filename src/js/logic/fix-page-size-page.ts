...
async function fixPageSize() {
  ...
  if (loaderText) loaderText.textContent = 'Padronizando páginas...';
  ...
  try {
    ...
    showAlert(
      'Sucesso',
      'Tamanhos de página padronizados com sucesso!',
      'success',
      () => {
        resetState();
      }
    ...
    console.error(e);
    showAlert('Erro', 'Ocorreu um erro ao padronizar as páginas.');
  } finally {
