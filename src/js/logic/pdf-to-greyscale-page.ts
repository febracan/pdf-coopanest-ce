...
async function convert() {
  ...
  try {
    ...
    if (!result) return;
    showLoader('Convertendo para escala de cinza...');
    ...
    showAlert(
      'Sucesso',
      'PDF convertido para escala de cinza com sucesso!',
      'success',
      () => {
        resetState();
      }
    ...
    showAlert(
      'Erro',
      'Falha ao converter o PDF para escala de cinza. O arquivo pode estar corrompido.'
    );
  } finally {
    hideLoader();
  }
